...
using WebApi_Data_Mng_Assignmt.Data;
using WebApi_Data_Mng_Assignmt.Models;

namespace WebApi_Data_Mng_Assignmt.Controllers
{
    public class TeamsController : ApiController
    {
        private TeamServiceContext db = new TeamServiceContext();
